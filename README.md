# scintilla-run organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`scintilla-run`](https://github.com/scintilla-run).

## Canonical organization links

- GitHub organization: https://github.com/scintilla-run
- Public organization defaults: https://github.com/scintilla-run/.github
